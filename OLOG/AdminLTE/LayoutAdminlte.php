		...
		<div class="wrapper">
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						foreach ($menu_arr as $menu_item_obj) {
							...
							$first_lvl_menu_active = self::isRequestedPage($menu_item_obj);
							$li_active = '';
							$ul_active = '';
							if ($first_lvl_menu_active) {
								$li_active = ' active ';
								$ul_active = ' menu-open ';
							}
							...
							if (count($children_arr)) {
								...
								foreach ($children_arr as $child_menu_item_obj) {
									...
									$secons_lvl_menu_active = self::isRequestedPage($child_menu_item_obj);
									$li_active = '';
									if ($secons_lvl_menu_active) {
										$li_active = ' active ';
									}
			...
			<div class="content-wrapper" <?= $override_background_color ?>>
				...
				<section class="content-header">
					...
					<?php
					$breadcrumbs_arr = array_merge($breadcrumbs_arr, ['<div class="bc-title">' . $h1_str . '</div>']);

					echo '<ol class="breadcrumb">';
					foreach ($breadcrumbs_arr as $bc_item_html) {
						echo '<li class="active">' . $bc_item_html . '</li>';
					}
					echo '</ol>';
